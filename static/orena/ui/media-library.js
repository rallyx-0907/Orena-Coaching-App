...
/* The listening browse surface retired with D-059 Phase 7: Listening opens on
   the same approved library as Reading, scoped to what can be listened to
   (ui/library-browse.js). What stays here is what still has a caller: the
   catalogue's identity boundary, the listening continuation read, the card the
   practice lists use, and the administrator's importer. */
