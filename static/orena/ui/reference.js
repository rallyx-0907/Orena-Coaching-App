...
export const referenceCopy = {
  en: {
    ...
    readerContents: 'Chapters', readerPaper: 'Paper', readerListen: 'Listen', readerNextChapter: 'Next chapter',
  ...
  zh: {
    ...
    readerContents: '目录', readerPaper: '纸色', readerListen: '朗读', readerNextChapter: '下一章',
