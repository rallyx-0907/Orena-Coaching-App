...
| Language knowledge | linguistic behavior and canonical Concept IDs; the horizontal Understanding Engine explanation capability grounds its explanations against this owner without replacing Concept IDs, and without requiring a new precomputed knowledge store (D-049/D-050, `ORENA_UNDERSTANDING_ENGINE.md`) | `writing_coach/languages/`, static grammar KB | all language-aware capabilities |
