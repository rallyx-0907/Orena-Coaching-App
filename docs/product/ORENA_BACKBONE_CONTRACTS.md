...
| Language knowledge | linguistic behavior and canonical Concept IDs; the Language Knowledge Graph and Understanding Engine explanation capability extend this owner (D-049, `ORENA_UNDERSTANDING_ENGINE.md`) without replacing Concept IDs | `writing_coach/languages/`, static grammar KB | all language-aware capabilities |
