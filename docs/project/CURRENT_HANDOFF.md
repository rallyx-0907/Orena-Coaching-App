...
(`docs/operations/SPEAKING_AZURE_E2E_2026-09-23.md`). D-077, D-078 and D-079 (three independent language layers) applied; verified on `4540efb`. Human: S24 (Grammar's way in), AUDIT-1b.
