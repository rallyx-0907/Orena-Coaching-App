...
(`docs/operations/SPEAKING_AZURE_E2E_2026-09-23.md`). D-077 done; D-078 (rule 49, viewport law; legacy routes redirect) applied to Speaking, measured on `4d83552`. Human: S24 (Grammar's way in).
