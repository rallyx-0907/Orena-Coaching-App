...
**Integration note (2026-09-26):** This proposal records the Admin-lane review
of `20260924_0014`. The integrated revision is `20260924_0016`, following the
renumbered Reading Content Engine. It needs independent delta review before
any shared-runtime apply. Historical paths and IDs below remain as proposed.
