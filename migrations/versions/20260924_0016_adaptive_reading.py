...
The Admin-lane predecessor was authorized for its sandbox (`DECISION_LOG.md`
D-083, 2026-09-24). This integration revision has a new ID and parent and
requires independent delta review and explicit runtime authorization before
any shared-runtime apply.
Written for the human direction of 2026-09-24 (D-082): Reading has one flow -
...
This is a **deliberate non-additive cutover** (D-083): the legacy
...
preview keep every gate. The predecessor's authorization does not transfer.
...
_REFUSAL = (
    "20260924_0016 downgrade refused - canonical Reading data exists. Downgrade never"
