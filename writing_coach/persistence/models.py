...
class LegacyReadingSession(Base):
    ...
    Archive only (D-075, D-076; migration `20260924_0014`): the table was
...
class ReadingArticle(Base):
    ...
    # What the learner is reading (D-076): the learner-facing content type,
...
# ---------------------------------------------------------------------------
# Canonical Reading (D-075, D-076; migration `20260924_0014`). One flow: a
